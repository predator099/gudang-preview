...
function applyTheme() {
  ...
  if (topIcon) topIcon.innerHTML = icon;
  const sbIcon = document.getElementById('theme-icon-sb');
  if (sbIcon) sbIcon.innerHTML = icon; // elemen ini sudah dihapus dari sidebar, dijaga null-safe
}
